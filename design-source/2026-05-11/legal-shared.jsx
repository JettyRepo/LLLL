    ...
    <>
      ...
      <section style={{ padding: '88px clamp(20px, 5vw, 56px) 0', maxWidth: 880, margin: '0 auto' }}>
        ...
        <div style={{ marginTop: 72, padding: '32px 0', borderTop: `1px solid ${rule}`, fontSize: 13, color: muted }}>
          Caerus Enterprises Inc. · 1045 Howe St, Vancouver, BC V6Z 2A9, Canada · <a className="marq-link" href="mailto:info@layrix.ai" style={{ color: ink, fontWeight: 500 }}>info@layrix.ai</a>
        </div>
      </section>
      <Footer />
    </>
