...
function Logo() {
  return (
    <span style={{ display: 'inline-flex', alignItems: 'center', gap: 12 }}>
      <span style={{ display: 'inline-block', width: 26, height: 26, background: 'var(--accent)', borderRadius: 13, position: 'relative', overflow: 'hidden' }}>
        <span style={{ position: 'absolute', inset: 5, background: 'var(--paper)', borderRadius: 9 }} />
        <span style={{ position: 'absolute', inset: 10, background: 'var(--accent)', borderRadius: 4 }} />
      </span>
